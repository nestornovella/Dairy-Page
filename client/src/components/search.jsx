    ...
    return (
        <div className="row d-flex justify-content-center mt-2 mb-0" >
            ...
            <div className="col-sm-12 col-xl-9 bg-dark p-3 rounded-4">
                ...
                <a href="https://api.whatsapp.com/send?phone=1125420570"><img width={50} src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/WhatsApp_icon.png/479px-WhatsApp_icon.png" alt="" /></a>
